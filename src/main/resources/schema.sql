CREATE TABLE meal_log (
                          email VARCHAR(255) PRIMARY KEY, -- Correo electrónico del usuario que registró la comida
...
CREATE INDEX idx_meal_log_email ON meal_log(email);
CREATE INDEX idx_meal_log_date ON meal_log(date);
CREATE INDEX idx_meal_log_meal_type ON meal_log(meal_type);
